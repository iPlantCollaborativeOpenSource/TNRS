...
<?php
	...
	foreach( $tests as $test ) {
		...
		$req = "http://arjuna.iplantcollaborative.org/taxamatch-webservice-read-only/api/taxamatch.php?cmd=compare_auth&auth1=$auth1&auth2=$auth2&debug=". $_REQUEST['debug'];
		print $req . "<br>";
